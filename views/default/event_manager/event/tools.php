<?php 
	...
	$toolLinks .= "<li>" . elgg_view("output/url", array("href" => "admin/moderator/publish/events_edit/" . $event->getGUID(), "text" => elgg_echo("event_manager:event:editevent"))) . "</li>";
	$toolLinks .= "<li>" . elgg_view("output/confirmlink", array("href" => "action/event_manager/event/delete?guid=" . $event->getGUID()."&admin=1", "text" => elgg_echo("event_manager:event:deleteevent"))) . "</li>";
