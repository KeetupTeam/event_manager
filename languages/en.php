...
$english = array(
	...
	'event_manager:program:day:add' => 'Add event day',
...
If you didn't request to unsubscribe from the event, please disregard this e-mail.",
	...
	'event_manager:speakers:form:bio:note' => 'Note: ',
	'event_manager:speakers:form:bio:characters' => 'Maximum %s characters',
	'event_manager:speakers:form:save' => 'Save',
	'event_manager:speakers:save:error' => 'There was an error when trying to save the speaker.',
	'event_manager:speakers:image:error' => 'The image is required.',
	'event_manager:speakers:name:error' => 'The name is required.',
	'event_manager:speakers:image:type:error' => 'Uploaded image does not correspond with the following formats: jpep, png, gif',
	'event_manager:speakers:url:error' => 'URL invalid.',
	'event_manager:speakers:save:success' => 'The speaker was successfully saved.',
	'event_manager:speakers:bio:error' => 'The bio only accepts %s characters.',
